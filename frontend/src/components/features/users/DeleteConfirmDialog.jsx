...
const DeleteConfirmDialog = ({ isOpen, onClose, onConfirm, userName }) => {
      ...
      <div className="relative z-10 w-full max-w-md rounded-xl border border-border bg-card shadow-lg mx-4">
        ...
        <div className="px-6 pb-6">
          <p className="text-sm text-foreground">
            ...
            <span className="font-semibold">{userName}</span>? This will
            permanently remove the user from your system.
          </p>
        </div>
