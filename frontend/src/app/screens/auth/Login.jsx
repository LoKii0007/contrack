    ...
    <div className="min-h-screen z-10 flex items-center justify-center p-4 bg-[#ffffff]">
      <div className="w-full max-w-md">
        <div className="bg-white backdrop-blur-sm rounded-3xl shadow-xl shadow-primary/20 border border-black/20 p-8 bg-gradient-to-b from-primary/20 to-white">
          ...
          <div className="mt-8 mb-6 w-full flex justify-between items-center">
            <div className="w-full border-t border-dark"></div>

            <div className="relative flex justify-center text-sm flex-shrink-0">
              <span className="px-4 text-gray-600">Or login in with</span>
            </div>
            <div className="w-full border-t border-dark"></div>
          </div>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <button
              ...
              className="w-13 h-12 bg-white hover:bg-gray-50 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 active:scale-95 flex items-center justify-center border border-gray-100"
            >
